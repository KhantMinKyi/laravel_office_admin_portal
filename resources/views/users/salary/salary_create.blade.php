    ...
    <div class=" fixed top-32 right-5 bottom-0 xl:left-72 md:left-1/4 overflow-y-auto" id="popup-model">
        ...
        <div class="flex items-center justify-center">
            <div class=" w-1/2 p-10 bg-white text-black dark:bg-mainbody-800 dark:text-white relative rounded">
                ...
                <div>
                    <h4 class="flex justify-center mb-4 font-semibold text-gray-500 dark:text-gray-100">Add Salary Form
                    </h4>
                    {{-- Include Create Salary --}}
                    <form action="{{ route('user_salary.store') }}" method="POST">
                        @csrf
                        <div class="grid gap-6 mb-6 md:grid-cols-1">
                            ...
                            <div>
                                ...
                                <input type="date" name="pay_date"
                                    ...
                                    placeholder="Choose Pay Date">
                            </div>
                        </div>
                        <div class="flex items-center">
                            <input name="is_encrypted" checked id="checked-checkbox" type="checkbox" value="1"
