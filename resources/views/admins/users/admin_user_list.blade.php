                ...
                <div class="bg-white dark:bg-mainbody-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @for ($i = 0 ; $i < 10 ; $i++)
                                <tr class="border-b dark:border-gray-700 hover:text-white hover:bg-mainbody-300 dark:hover:bg-mainbody-700 hover:cursor-pointer">
                                    <th scope="row"
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <button onclick="togglePopupViewModel({{$i}})">
                                            <i class="fa-regular fa-eye text-mainbody-100 hover:text-white  dark:text-mainbody-400 mr-1"></i>
                                        </button>
                                        {{-- view dot --}}
                                        ...
                                        <div id="apple-imac-{{$i}}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <button
                                                        class=" w-full text-left block py-2 px-4 hover:bg-gray-100 dark:hover:bg-mainbody-600 dark:hover:text-white" onclick="togglePopupEditModel()">Edit</button>
                                                </li>
                                            </ul>
                                            <div class="py-1">
                                                <a href="#"
        ...
        <div class="hidden fixed top-16 right-5 bottom-0 xl:left-72 md:left-1/4 overflow-y-auto" id="popup-model" >
            ...
            <div class="flex items-center justify-center">
                <div class="p-10 bg-white text-black dark:bg-mainbody-800 dark:text-white relative rounded">
                    ...
                    <div>
                        <h4 class="flex justify-center mb-4 font-semibold text-gray-500 dark:text-gray-100">Add Admin Form</h4>
                        {{-- Include Create User --}}
                        @include('admins.partial_view.users.create_user')
                    </div>
            ...
            <div class="hidden fixed top-16 right-5 bottom-0 xl:left-72 md:left-1/4 overflow-y-auto" id="popup-view-model" >
                ...
                <div class="flex items-center justify-center">
                    <div class="p-10 bg-gray-50 text-black dark:bg-mainbody-900 dark:text-white relative rounded">
                        ...
                        {{-- Include User View --}}
                        @include('admins.partial_view.users.view_user')
                    </div>
                </div>
            </div>
                {{-- Popup Edit Model --}}
                <div class="hidden fixed top-16 right-5 bottom-0 xl:left-72 md:left-1/4 overflow-y-auto" id="popup-edit-model" >
                    ...
                    <div class="flex items-center justify-center">
                        <div class="p-10 bg-white text-black dark:bg-mainbody-800 dark:text-white relative rounded">
                            ...
                            <div>
                                <h4 class="flex justify-center mb-4 font-semibold text-gray-500 dark:text-gray-100">Edit Admin Form</h4>
                                {{-- Include Edit User --}}
                                @include('admins.partial_view.users.edit_user')
                            </div>
