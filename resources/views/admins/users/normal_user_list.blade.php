                                ...
                                @foreach ($normal_users as $key => $normal_user)
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            {{ $normal_user->full_name }}</th>
                                        <td class="px-4 py-3">{{ $normal_user->username }}</td>
                                        <td class="px-4 py-3">{{ $normal_user->email }}</td>
                                        <td class="px-4 py-3">{{ $normal_user->department->name }}</td>
                                        <td class="px-4 py-3">{{ $normal_user->position }}</td>
                                        <td class="px-4 py-3 flex items-center justify-end"
                                            data-id="{{ $normal_user->id }}">
                                            {{-- view button --}}
                                            ...
                                            {{-- view dot --}}
                                            <button id="apple-imac-{{ $normal_user->id }}-dropdown-button"
                                                data-dropdown-toggle="apple-imac-{{ $normal_user->id }}-dropdown"
                                            ...
                                            <div id="apple-imac-{{ $normal_user->id }}-dropdown"
                                                class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-mainbody-700 dark:divide-mainbody-600">
                                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <a href="#"
                                                    ...
                                                    <li>
                                                        <button
                                                            ...
                                                            onclick="togglePopupEditModel({{ $normal_user->id }})">Edit</button>
                                                    </li>
                                                </ul>
                                                <div class="py-1">
                                                    <a href="#"
