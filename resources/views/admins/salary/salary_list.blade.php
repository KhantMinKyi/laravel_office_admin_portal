                        ...
                        <form action="{{ route('salary.index') }}" method="GET"
                            ...
                            <div
                                ...
                                <button type="submit" id="search-button"
                                    class="search flex items-center justify-center text-white bg-teal-300 hover:bg-teal-700 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-teal-600 dark:hover:bg-teal-700 focus:outline-none dark:focus:ring-teal-800">
                                    Search
                                </button>
                            </div>
                        </form>
                                            ...
                                            <div id="apple-imac-{{ $key }}-dropdown"
                                                ...
                                                <a href="#"
                                                    ...
                                                    @if (Auth::user()->id != $salary->user->id)
                                                        <li>
                                                            <a href="{{ route('salary.edit', ['salary' => $salary->id]) }}"
                                                ...
                                                <div class="py-1">
                                                    <form
                                                        action="{{ route('salary.destroy', ['salary' => $salary->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type='submit'
