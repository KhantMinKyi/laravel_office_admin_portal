                                ...
                                @foreach ($keys as $no => $key)
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            {{ $key->name }}</th>
                                        <td class="px-4 py-3">
                                            <input type="password" name="" id="" value="{{ $key->key }}"
                                    ...
                                    <tr
                                        ...
                                        <td class="px-4 py-3">
                                            <input type="password" name="" id=""
                                                value="{{ $key->key }}" class="bg-transparent border-none" disabled>
                                        </td>
                                        <td class="px-4 py-3">{{ $key->is_active }}</td>
                                        <td class="px-4 py-3">{{ $key->is_encrypted }}</td>
                                        <td class="px-4 py-3 flex items-center justify-end"
                                            ...
                                            {{-- view dot --}}
                                            <button id="apple-imac-{{ $key->id }}111-dropdown-button"
                                                data-dropdown-toggle="apple-imac-{{ $key->id }}111-dropdown"
                                                class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                                                type="button">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                                    viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div id="apple-imac-{{ $key->id }}111-dropdown"
                                                class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-mainbody-700 dark:divide-mainbody-600">
                                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                    aria-labelledby="apple-imac-27-dropdown-button">
                                                    {{-- <li>
