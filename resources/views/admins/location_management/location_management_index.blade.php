                        ...
                        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
                            ...
                            <li class="me-2" role="presentation">
                                <button class="inline-block p-4 border-b-2 rounded-t-lg" id="view-city-tab"
                                    data-tabs-target="#view-city" type="button" role="tab"
                                    aria-controls="view-city-tab" aria-selected="false">City</button>
                            </li>
                            <li class="me-2" role="presentation">
                                <button
                            ...
                            <li class="me-2" role="presentation">
                                <button
                                    class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                    id="view-department-tab" data-tabs-target="#view-department" type="button"
                                    role="tab" aria-controls="settings" aria-selected="false">Department</button>
                            </li>
                        </ul>
                    </div>
