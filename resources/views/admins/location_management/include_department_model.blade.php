...
<div class="hidden fixed top-16 right-5 bottom-0 xl:left-72 md:left-1/4 overflow-y-auto"
    ...
    <div class="flex items-center justify-center">
        <div class="p-10 bg-gray-50 text-black dark:bg-mainbody-800 dark:text-white relative rounded">
            ...
            @include('admins.partial_view.location_management.department.view_department_user')
        </div>
    </div>
</div>
{{-- Popup Edit Model --}}
    ...
    <div class="flex items-center justify-center">
        <div class="p-10 bg-white text-black dark:bg-mainbody-800 dark:text-white relative rounded w-1/2 xl:w-1/3">
            ...
            <div>
                ...
                {{-- Include Edit User --}}
                @include('admins.partial_view.location_management.department.edit_department')
            </div>
