...
<div class="hidden fixed top-1/3 right-5 bottom-0 xl:left-72 md:left-1/4 overflow-y-auto" id="popup-branch-add-model">
...
<div class="hidden fixed top-16 right-5 bottom-0 xl:left-72 md:left-1/4 overflow-y-auto" id="popup-branch-view-model">
    <div class="fixed top-10 right-0 bottom-0 left-0 bg-black opacity-50">
    </div>
    <div class="flex items-center justify-center">
...
{{-- Popup Edit Model --}}
<div class="hidden fixed top-1/3 right-5 bottom-0 xl:left-72 md:left-1/4 overflow-y-auto" id="popup-branch-edit-model">
    <div class="fixed top-10 right-0 bottom-0 left-0 bg-black opacity-50">
    </div>
    <div class="flex items-center justify-center">
        <div class="p-10 bg-white text-black dark:bg-mainbody-800 dark:text-white relative rounded w-1/2 xl:w-1/3">
