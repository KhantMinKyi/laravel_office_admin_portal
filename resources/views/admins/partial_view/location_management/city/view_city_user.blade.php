{{-- City User List --}}
    <div class="overflow-x-auto">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead
                class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-mainbody-700 dark:text-gray-200">
                <tr>
            ...
            <tbody>
                @for ($i = 0 ; $i < 10 ; $i++)
                <tr class="border-b dark:border-gray-700 hover:text-white hover:bg-mainbody-200 dark:hover:bg-mainbody-700 hover:cursor-pointer ">
                    <th scope="row"
                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        {{$i + 1}}</th>
                    <td class="px-4 py-5">Khant Min Kyi</td>
                    <td class="px-4 py-5">Developer</td>
                    <td class="px-4 py-5">Yangon</td>
