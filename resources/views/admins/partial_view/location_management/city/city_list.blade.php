                ...
                @foreach ($cities as $city_key => $city)
                    <tr
                        ...
                        <td class="px-4 py-3 flex items-center justify-end">
                            ...
                            {{-- view dot --}}
                            <button id="city-imac-{{ $city_key }}-dropdown-button"
                                data-dropdown-toggle="city-imac-{{ $city_key }}-dropdown"
                            ...
                            <div id="city-imac-{{ $city_key }}-dropdown"
                                ...
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <button
                                            ...
                                            onclick="togglePopupCityEditModel()">Edit</button>
                                    </li>
                                </ul>
                                <div class="py-1">
                                    <a href="#"
