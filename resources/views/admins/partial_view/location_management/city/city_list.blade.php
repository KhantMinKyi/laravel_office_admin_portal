            ...
            <tbody>
                ...
                <tr class="border-b dark:border-gray-700 hover:text-white hover:bg-mainbody-300 dark:hover:bg-mainbody-700 hover:cursor-pointer">
                    ...
                    <td class="px-4 py-3 flex items-center justify-end">
                        {{-- view button --}}
                        <button onclick="togglePopupCityViewModel({{$i}})">
                            <i class="fa-regular fa-eye text-mainbody-100 hover:text-white  dark:text-mainbody-400 mr-1"></i>
                        </button>
                        {{-- view dot --}}
                        <button id="city-imac-{{$i}}-dropdown-button"
                            data-dropdown-toggle="city-imac-{{$i}}-dropdown"
                        ...
                        <div id="city-imac-{{$i}}-dropdown"
                            ...
                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <button
                                        class=" w-full text-left block py-2 px-4 hover:bg-gray-100 dark:hover:bg-mainbody-600 dark:hover:text-white" onclick="togglePopupCityEditModel()">Edit</button>
                                </li>
                            </ul>
                            <div class="py-1">
                                <a href="#"
