            ...
            <tbody>
                @for ($i = 0 ; $i < 10 ; $i++) <tr
                    ...
                    <td class="px-4 py-3 flex items-center justify-end">
                        {{-- view button --}}
                        <button onclick="togglePopupBranchViewModel({{$i}})">
                            <i
                                class="fa-regular fa-eye text-mainbody-100 hover:text-white  dark:text-mainbody-400 mr-1"></i>
                        </button>
                        {{-- view dot --}}
                        <button id="branch-imac-{{$i}}-dropdown-button"
                            data-dropdown-toggle="branch-imac-{{$i}}-dropdown"
                            ...
                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <button
                                        ...
                                        onclick="togglePopupBranchEditModel()">Edit</button>
                                </li>
                            </ul>
                            <div class="py-1">
                                <a href="#"
