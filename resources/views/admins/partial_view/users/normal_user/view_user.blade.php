                            ...
                            <div class="col-span-4 sm:col-span-3 md:col-span-full xl:col-span-3">
                                <div class="bg-white dark:bg-mainbody-800 shadow rounded-lg p-6">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h1 class="text-xl font-bold">{{ $normal_user->full_name }}</h1>
                                        <p class="text-gray-700 dark:text-gray-300">{{ $normal_user->position }}</p>
                                        <div class="mt-6 flex flex-wrap gap-4 justify-center">
                                            <p class="text-gray-700 dark:text-gray-300">{{ $normal_user->branch->name }}
                                            </p>
                                            <p class="text-gray-700 dark:text-gray-300">
                                                {{ $normal_user->department->name }}</p>
                                        </div>
                                    </div>
                                                ...
                                                <div>
                                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4
                                                                class=" bg-gray-100 dark:bg-mainbody-700 p-2 rounded font-medium">
                                                                {{ date('d.m.Y', strToTime($normal_user->date_of_birth)) }}
                                                            </h4>
                                                        </div>
                                                        <div>
                                                            <label for="nrc"
