...
@section('content')
    @if (Auth::user()->id != $admin_user->id)
        <div class="text-6xl text-red-900 font-bold text-center mt-5"> Error !!! </div>
        <div class="text-4xl text-mainbody-300 font-bold text-center mt-5"> Don't Do Something Serious! You Will Be
            Reported
            !
        </div>
    @else
        <div>
            ...
            <div class="flex items-center justify-center">
                <div class="p-10 bg-gray-50 text-black dark:bg-mainbody-900 dark:text-white relative rounded">
                    ...
                    <div>
                        <h1 class="flex justify-center mb-4 font-semibold text-gray-500 dark:text-gray-200 text-lg">Profile
                        </h1>
                                ...
                                <div class="grid  sm:grid-cols-12 md:grid-cols-1 xl:grid-cols-12 gap-6 px-4">
                                        ...
                                        <div class="bg-white dark:bg-mainbody-800 shadow rounded-lg p-6 overflow-hidden">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="data_input_view text-gray-700 dark:text-gray-300">
                                                    {{ $admin_user->position }}</p>
                                                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                                                    <p class="text-gray-700 dark:text-gray-300">
                                                        {{ $admin_user->branch->name }}
                                                    </p>
                                                    <p class="text-gray-700 dark:text-gray-300">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="mb-2">
                                                        <div class="grid mb-6  font-semibold text-gray-400 overflow-hidden">
                                                            <h5>Email</h5>
                                                            <h5 class="data_input_view">{{ $admin_user->email }}</h5>
                                                            <div>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="col-span-4 sm:col-span-9 md:col-span-full xl:col-span-9">
                                        <div class="mb-4 border-b border-gray-200 dark:border-mainbody-700">
                                            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
                                                ...
                                                <li class="me-2" role="presentation">
                                                    <button
                                                        class="inline-block p-4 border-b-2 rounded-t-lg hover:text-mainbody-600 hover:border-mainbody-300 dark:hover:text-mainbody-300"
                                                        id="view-job-tab" data-target="#view-job" type="button">Job &
                                                        Account
                                                    </button>
                                                </li>
                                            </ul>
                                        ...
                                        <div>
                                            ...
                                            {{-- Contact --}}
                                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-mainbody-900"
                                                id="view-contact" role="tabpanel" aria-labelledby="view-contact-tab">
                                                <div class="bg-white dark:bg-mainbody-800 shadow rounded-lg p-6">
                                                    <div class="overflow-hidden">
                                            ...
                                            {{-- Job description --}}
                                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-mainbody-900"
                                                id="view-job" role="tabpanel" aria-labelledby="view-job-tab">
                                                <div class="bg-white dark:bg-mainbody-800 shadow rounded-lg p-6">
                                                    <div class="overflow-hidden">
    ...
    <script src="/js/admin/user/user_profile.js"></script>
