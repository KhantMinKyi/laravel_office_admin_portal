...
$(document).on("click", "#btnDecryptEdit", function () {
    var selectedOption = $("#edit_encryption_key").find("option:selected");
    var encryptedKey = selectedOption.data("edit_encryption_key");
    $(".data_input").each(function (index) {
        ...
        $(".data_input").eq(index).val(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptEdit", function () {
    var selectedOption = $("#edit_encryption_key").find("option:selected");
    var encryptedKey = selectedOption.data("edit_encryption_key");
    $(".data_input").each(function (index) {
        var value = $(this).val();
        ...
        $(".data_input").eq(index).val(btoa(result));
    });
});
