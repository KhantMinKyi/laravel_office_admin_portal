...
$(document).on("click", "#btnDecryptViewCityForBranch", function () {
    var selectedOption = $("#view_city_for_branch_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
        "view_city_for_branch_encryption_key"
    );
    $(".data_input_view_city_for_branch").each(function (index) {
        ...
        $(".data_input_view_city_for_branch")
            .eq(index)
...
$(document).on("click", "#btnEncryptViewCityForBranch", function () {
    ...
    $(".data_input_view_city_for_branch").each(function (index) {
        ...
        $(".data_input_view_city_for_branch").eq(index).text(btoa(result));
    });
});
