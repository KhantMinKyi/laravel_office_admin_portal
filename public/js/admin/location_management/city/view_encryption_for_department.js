...
$(document).on("click", "#btnDecryptViewCityForBranch", function () {
    var selectedOption = $("#view_city_for_department_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
        "view_city_for_department_encryption_key"
    );
    $(".data_input_view_city_for_department").each(function (index) {
        ...
        $(".data_input_view_city_for_department")
            .eq(index)
            .text(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptViewCityForBranch", function () {
    var selectedOption = $("#view_city_for_department_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
    ...
    $(".data_input_view_city_for_department").each(function (index) {
        ...
        $(".data_input_view_city_for_department").eq(index).text(btoa(result));
    });
});
