...
$(document).on("click", "#btnDecryptViewCityForAdmin", function () {
    var selectedOption = $("#view_city_for_admin_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
        "view_city_for_admin_encryption_key"
    );
    $(".data_input_view_city_for_admin").each(function (index) {
        ...
        $(".data_input_view_city_for_admin").eq(index).text(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptViewCityForAdmin", function () {
    var selectedOption = $("#view_city_for_admin_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
    ...
    $(".data_input_view_city_for_admin").each(function (index) {
        ...
        $(".data_input_view_city_for_admin").eq(index).text(btoa(result));
    });
});
