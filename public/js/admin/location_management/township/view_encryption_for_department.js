...
$(document).on("click", "#btnDecryptViewTownshipForBranch", function () {
    var selectedOption = $("#view_township_for_department_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
        "view_township_for_department_encryption_key"
    );
    $(".data_input_view_township_for_department").each(function (index) {
        ...
        $(".data_input_view_township_for_department")
            .eq(index)
