...
$(document).on("click", "#btnDecryptEditTownshipForDepartment", function () {
    var selectedOption = $("#edit_township_for_department_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
        "edit_township_for_department_encryption_key"
    );
    $(".data_input_edit_township_for_department").each(function (index) {
        ...
        $(".data_input_edit_township_for_department")
            .eq(index)
            .text(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptEditTownshipForDepartment", function () {
    var selectedOption = $("#edit_township_for_department_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
