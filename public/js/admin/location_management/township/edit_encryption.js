...
$(document).on("click", "#btnDecryptEditTownship", function () {
    var selectedOption = $("#edit_township_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data("edit_township_encryption_key");
    $(".data_input_edit_township").each(function (index) {
        ...
        $(".data_input_edit_township").eq(index).val(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptEditTownship", function () {
    var selectedOption = $("#edit_township_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data("edit_township_encryption_key");
    $(".data_input_edit_township").each(function (index) {
        ...
        $(".data_input_edit_township").eq(index).val(btoa(result));
    });
});
