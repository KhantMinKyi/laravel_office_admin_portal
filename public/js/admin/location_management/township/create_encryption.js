...
$(document).on("click", "#btnDecryptCreateTownship", function () {
    var selectedOption = $("#create_township_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data("create_township_encryption_key");
    $(".data_input_township").each(function (index) {
        ...
        $(".data_input_township").eq(index).val(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptCreateTownship", function () {
    var selectedOption = $("#create_township_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data("create_township_encryption_key");
    $(".data_input_township").each(function (index) {
        ...
        $(".data_input_township").eq(index).val(btoa(result));
    });
});
