...
$(document).on("click", "#btnDecryptViewTownship", function () {
    var selectedOption = $("#view_township_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data("view_township_encryption_key");
    $(".data_input_view_township").each(function (index) {
        ...
        $(".data_input_view_township").eq(index).text(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptViewTownship", function () {
    var selectedOption = $("#view_township_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data("view_township_encryption_key");
    $(".data_input_view_township").each(function (index) {
        ...
        $(".data_input_view_township").eq(index).text(btoa(result));
    });
});
