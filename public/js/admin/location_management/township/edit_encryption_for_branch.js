...
$(document).on("click", "#btnDecryptEditTownshipForBranch", function () {
    var selectedOption = $("#edit_township_for_branch_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
        "edit_township_for_branch_encryption_key"
    );
    $(".data_input_edit_township_for_city").each(function (index) {
        ...
        $(".data_input_edit_township_for_city")
            .eq(index)
            .text(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptEditTownshipForBranch", function () {
    var selectedOption = $("#edit_township_for_branch_encryption_key").find(
        "option:selected"
    );
    var encryptedKey = selectedOption.data(
    ...
    $(".data_input_edit_township_for_city").each(function (index) {
        ...
        $(".data_input_edit_township_for_city").eq(index).text(btoa(result));
    });
});
