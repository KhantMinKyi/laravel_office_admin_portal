...
$(document).on("click", "#btnDecryptView", function () {
    var selectedOption = $("#view_encryption_key").find("option:selected");
    var encryptedKey = selectedOption.data("view_encryption_key");
    $(".data_input_view").each(function (index) {
        ...
        $(".data_input_view").eq(index).text(pkcs7Unpad(result));
    });
});

$(document).on("click", "#btnEncryptView", function () {
    var selectedOption = $("#view_encryption_key").find("option:selected");
    var encryptedKey = selectedOption.data("view_encryption_key");
    $(".data_input_view").each(function (index) {
        var value = $(this).text();
        ...
        $(".data_input_view").eq(index).text(btoa(result));
    });
});
